 ...
 * Main Component
 */
export class DocCenter_Leasing extends React.Component<any, any> {
    isMore: boolean;
    items;
    //count:number;
    ...
    componentWillMount() {
        ...
        service.getListItemsWithPaging('documents/leasing', 'LeasingDocuments', columns).then((data: any) => {
    ...
    showComponent() {
        ReactDOM.render(
            <DocCenter_Leasing/>,
            document.getElementById('doc-results-leasing')
        );
    }
}
